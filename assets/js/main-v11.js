(() => {
  ...
  const labels = {
    en:{home:'Home',developers:'For Developers',projects:'Projects',bim:'BIM + Digital',services:'Services',about:'Studio',contact:'Contact',enquire:'Define the opportunity',language:'AR',rights:'All rights reserved.'},
    ar:{home:'الرئيسية',developers:'للمطورين',projects:'المشاريع',bim:'BIM + رقمنة',services:'الخدمات',about:'الاستوديو',contact:'تواصل',enquire:'عرّف الفرصة',language:'EN',rights:'جميع الحقوق محفوظة.'}
  };
