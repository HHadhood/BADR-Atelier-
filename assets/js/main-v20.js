...
(() => {
  ...
  const boot = async () => {
    addCss('assets/badr-ai/badr-ai.css?v=1.0.4');
    try { await addScript('assets/badr-ai/badr-ai-config.js?v=1.0.4'); await addScript('assets/badr-ai/badr-ai.js?v=1.0.4'); }
