...
(() => {
  ...
  const boot = async () => {
    addCss('assets/badr-ai/badr-ai.css?v=2.1.0');
    try { await addScript('assets/badr-ai/badr-ai-config.js?v=2.1.0'); await addScript('assets/badr-ai/badr-ai.js?v=2.1.0'); }
