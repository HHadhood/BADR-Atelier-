...
## تحديث V18
- رسائل مؤسس منفصلة للمطور والمستثمر والاستوديو.
- صفحة Team جديدة.
- شريط متحرك لمنظومة المطورين والشركاء، وآخر لمنظومة المستثمرين.
- تم استخدام تسميات ecosystem / partner profiles بدل نسبة شركات غير موثقة كعملاء فعليين. استبدل البلاطات بشعارات العملاء الموثقين عند توفرها.
- ملفات الواجهة: styles-v18.css و main-v18.js.
